---
title: 'AI Gateway: Định tuyến AI đa nhà cung cấp với kiểm soát chi phí'
sidebarTitle: 'AI Gateway'
description: 'CyberOS AI Gateway định tuyến các yêu cầu AI qua nhiều nhà cung cấp (Anthropic, OpenAI, Bedrock) với giới hạn chi phí theo tenant, ẩn danh PII và sổ cái chi phí đầy đủ.'
---
