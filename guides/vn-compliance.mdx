...
Vietnam's Personal Data Protection Law (Law 91/2025) — commonly called the PDPL — is the primary framework governing how CyberOS handles personal data for Vietnamese-market tenants. CyberOS targets the `vn-1` residency tier, which activates Decree 13/2023 and Decree 53/2022 data-localisation rules alongside the PDPL.
...
<Steps>
  ...
  <Step title="Standard overtime ceiling">
    The default annual overtime ceiling is **200 hours per year** (Labour Code Art. 107 standard limit). TIME's `law_caps.rs` evaluates each new overtime entry against the running annual total. Entries that would exceed 200 hours are blocked at the API and page the CHRO.
  </Step>
...
| Maternity leave | Labour Code 2019 Art. 139, Decree 13/2023 | 6 months for mothers; BHXH-funded |
| Paternity leave | Labour Code 2019 Art. 34, Decree 13/2023 | 5–14 days depending on delivery type |
...
<Note>
  Maternity and paternity leave under Decree 13/2023 supplements the baseline Labour Code 2019 entitlements. CyberOS tags leave records with both the Labour Code article and the relevant Decree so downstream payroll reporting in REW can distinguish BHXH-funded leave from employer-funded leave.
</Note>
...
| HR | 8 statutory leave types tagged to Labour Code 2019, Decree 145/2020, Decree 13/2023 |
