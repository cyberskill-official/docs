---
title: 'MCP Gateway: Connect Any AI Agent to CyberOS Tools'
sidebarTitle: 'MCP Gateway'
description: 'CyberOS MCP Gateway implements the Model Context Protocol, exposing tools and memory to any MCP-compatible agent — Claude, Cursor, Codex, and more.'
---
