---
title: 'OBS: Observability, Alerts, and Runbooks'
sidebarTitle: 'OBS'
...
<Steps>
  <Step title="Alert fires">
    Prometheus evaluates the alert rule. When the condition has been met for the configured duration, the alert transitions to Firing state.
  </Step>
