---
title: 'CyberOS AUTH: Sign-In Options, Roles, and MFA Setup'
sidebarTitle: 'Auth'
description: 'Manage sign-in methods, passkey MFA enrollment, role-based access, session revocation, and travel policy exceptions in CyberOS AUTH.'
---
