---
title: 'CyberOS CHAT: Team Messaging, Calls, and AI Teammates'
sidebarTitle: 'Chat'
description: 'Send messages, start voice and video calls, invoke @genie AI responses, and auto-log CRM activities — all inside CyberOS CHAT without external tools.'
---
