---
title: 'Skills: Verifiable Agent Capabilities'
sidebarTitle: 'Skills'
description: 'CyberOS Skills package what agents can do into versioned, auditable capabilities. Each skill has a SKILL.md contract, structured inputs/outputs, and an audit sibling.'
---
